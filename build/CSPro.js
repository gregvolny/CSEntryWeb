...
// include: C:\Users\Admin\AppData\Local\Temp\tmpn5syhde_.js
...
// end include: C:\Users\Admin\AppData\Local\Temp\tmpn5syhde_.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpm3zy7nqa.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpm3zy7nqa.js
// include: C:\Users\Admin\AppData\Local\Temp\tmpnwtsmzh9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Admin\AppData\Local\Temp\tmpnwtsmzh9.js
...
// Begin JS library code
  ...
  __emval_create_invoker.sig = 'pipi';
...
var ASM_CONSTS = {
  1416212: ($0) => { var text = UTF8ToString($0); if (navigator.clipboard && navigator.clipboard.writeText) { navigator.clipboard.writeText(text).catch(function(err) { console.warn('Could not copy text to clipboard:', err); }); } else { var textArea = document.createElement("textarea"); textArea.value = text; textArea.style.position = "fixed"; textArea.style.left = "-999999px"; document.body.appendChild(textArea); textArea.select(); try { document.execCommand('copy'); } catch (err) { console.warn('Fallback clipboard copy failed:', err); } document.body.removeChild(textArea); } },  
 1416779: ($0) => { console.error("[CSPro Error]", UTF8ToString($0)); alert(UTF8ToString($0)); }
};
